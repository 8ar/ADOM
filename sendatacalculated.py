...
print "El tiempo minimo entre flancos de subida y bajada es "+str(spacemin)
# **************************
...
for j in range(0,len(mess),32):
    # print mess[j:3]
    sub = mess[j:j+32]
    print "Byte del mensaje "+sub
...
# Configure the radio
d.makePktFLEN(len(rf_data)) # Set the RFData packet length
d.setMdmDRate(3500)         # Set the Baud Rate
d.setMdmSyncMode(0)         # Disable preamble
d.setFreq(315010000)        # Set the frequency
d.setMaxPower()
# Send the data string a few times
print "sending data"
d.RFxmit(rf_data, repeat=1)
d.setModeIDLE()
# **************************
# Fin del envio de informacion por radio frecuencia
# **************************
